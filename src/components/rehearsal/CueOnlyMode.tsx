...
export default function CueOnlyMode({
  ...
  // Find the cue (last line spoken before the current one)
  let cueLine: ScriptLine | null = null;
  if (currentLineIndex > 0) {
    cueLine = dialogueLines[currentLineIndex - 1];
  }

  // Find the upcoming user line if it's not currently the user's turn
        ...
        {isMyTurn ? (
          ...
          >
            ...
            <div
              ...
              style={{
                animation: "cue-glow 2s ease-in-out infinite",
              }}
            />
