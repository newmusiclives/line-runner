...
const MODES: ModeCard[] = [
  ...
  },
  {
    ...
    name: "Monologue",
    tag: "NEW",
    description: "First-words prompts for long speeches — peek the start of each line, recall the rest",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    name: "Cold Read",
    tag: "NEW",
    description: "Script revealed one line at a time — genuine discovery on every exchange",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    name: "Wildcard",
    tag: "NEW",
    description: "AI gives a different emotional interpretation on every take — stay surprised",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    name: "Subtext",
    tag: "NEW",
    description: "AI performs the unspoken intention beneath the words — jealousy, terror, calm facade",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    id: "backstage",
    name: "Backstage",
    description: "Audio only, no text shown — listen and respond from memory",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    name: "Sleep Learning",
    tag: "NEW",
    description: "Slow looping playback designed for passive memorisation before sleep",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
