  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden py-16 sm:py-24 md:py-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-3 sm:flex sm:items-center sm:justify-center gap-3 sm:gap-8 mt-8 sm:mt-10 text-sm sm:text-base text-muted">
            <span className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2"><span className="text-xl sm:text-2xl font-bold text-accent-light">30</span> Features</span>
      ...
      <section className="py-16 sm:py-20 border-t border-border bg-gradient-to-b from-accent/5 to-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3">Simple, credit-based pricing</h2>
          <p className="text-muted text-base sm:text-lg max-w-xl mx-auto mb-8 sm:mb-10">1 credit = 1 character of AI dialogue. ~1,000 credits = ~1 minute of audio. Start free, upgrade when you&apos;re ready.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 max-w-5xl mx-auto">
            ...
            <div className="bg-surface border border-border rounded-2xl p-6 sm:p-8">
              ...
              <div className="text-2xl font-bold mb-1">$70<span className="text-lg text-muted font-normal">/mo</span></div>
