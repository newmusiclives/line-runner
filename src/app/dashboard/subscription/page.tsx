...
const PLANS = [
  {
    ...
    period: "forever",
    minutes: 2.5,
    features: ["2.5 voice minutes", "1 script upload", "Basic rehearsal mode", "Community support"],
  },
  {
    id: "monthly",
    name: "Pro",
    ...
    period: "/month",
    minutes: 60,
    features: ["60 voice minutes", "Unlimited scripts", "All voice styles", "Scene Exchange access", "Priority support"],
    popular: true,
  },
  {
    id: "studio",
    ...
    period: "/month",
    minutes: 200,
    features: ["200 voice minutes", "Unlimited everything", "Custom voice cloning", "API access", "Dedicated support", "Team collaboration"],
  },
];
